                    ...
                    VStack(alignment: .leading, spacing: 18) {
                        ...
                        VStack(spacing: 12) {
                            ZStack {
                                ...
                                RotatingGlowRing(lineWidth: 2.2)
                        ...
                        .glassPanel(accent: AvionicsTheme.teal, cornerRadius: 16)
                        ...
                        .padding(14)
                        .glassPanel(accent: AvionicsTheme.mint, cornerRadius: 12, glow: false, tint: 0.6)
