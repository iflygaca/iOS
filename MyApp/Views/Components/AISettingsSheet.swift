            ...
            ZStack {
                ...
                ScrollView {
                    VStack(alignment: .leading, spacing: 18) {
                                ...
                                ForEach(AIProviderType.allCases) { provider in
                                    Button(action: {
                                        ...
                                        HStack(spacing: 12) {
                                            ZStack {
                                                Circle()
                                                    .stroke(selectedProvider == provider ? AvionicsTheme.cyan : AvionicsTheme.line, lineWidth: 1.5)
                                            ...
                                            VStack(alignment: .leading, spacing: 2) {
                                                HStack {
                                                    Text(provider.displayName)
                                                        ...
                                                        .foregroundColor(selectedProvider == provider ? AvionicsTheme.ink : AvionicsTheme.inkDim)
                                                    Spacer()
                                                    Text(provider.shortBadge)
                                                        .font(.system(size: 8.5, weight: .heavy, design: .monospaced))
                                                        .padding(.horizontal, 5)
                                                        .padding(.vertical, 2)
                                                        .background(selectedProvider == provider ? AvionicsTheme.cyan.opacity(0.15) : AvionicsTheme.panel2)
                                                        .foregroundColor(selectedProvider == provider ? AvionicsTheme.cyan : AvionicsTheme.inkDim)
                                                        .cornerRadius(3)
                                                }
                                            }
                                        }
                                        ...
                                        .background(
                                            RoundedRectangle(cornerRadius: 6)
                                                .fill(selectedProvider == provider ? AvionicsTheme.panel2 : AvionicsTheme.panel)
                                                .overlay(
                                                    RoundedRectangle(cornerRadius: 6)
                                                        .stroke(selectedProvider == provider ? AvionicsTheme.teal : AvionicsTheme.line, lineWidth: 1)
                                                )
                                        )
                                    }
                                    .buttonStyle(.plain)
                        ...
                        // Parameters for Online Providers
                        if selectedProvider != .offlineDoctrine {
                            ...
                            // Offline Doctrine Explainer Card
                            VStack(alignment: .leading, spacing: 8) {
                                HStack(spacing: 6) {
